...
try:
    ...
    # year = 2015
    # month = 1
    DBfile = ur"D:/Python/sunyx/access/cache-中债指数样本券数据(历史)_20170926_3" + ".mdb"
    print DBfile
    ...
    for i in range(0,sheet.nrows):
        if len(str(sheet.row_values(i)[0])) > 1:
            ...
            for p_termtype in p_termtype_list:
                params = "function_id=107022&p_indextype=&p_termtype=" + p_termtype[1] + "&p_sdate=" + p_sdate + "&p_in_queryyear=1"
